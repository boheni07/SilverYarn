...
| PDCA 문서 | `docs/01-plan/features/silveryarn-platform.plan.md`(v0.4), `docs/02-design/features/silveryarn-platform.design.md`(v0.34), `docs/03-check/gap-analysis-2026-09-10.md`, `docs/03-check/blocked-decisions-tracker.md`(법무·인프라 회신 대기 트래커), `docs/04-report/features/silveryarn-platform.report.md` |
| 동기화 계약 | `docs/02-design/sync-contract.md` — 비동기 업로드(202+job_id), 엔티티별 충돌정책, Presigned URL, 증분 다운로드 |
| 의사결정 로그 | `docs/01-plan/decisions/silveryarn-platform.decisions.md`(v0.19) (기획서 9장 + design-validator 반영 항목) |
