...
| [mobile-schema.md](./mobile-schema.md) | ✅ Approved | 2026-09-14 (v0.12) | NUBiz AX Initiative | 온디바이스 SQLite 로컬 스키마 (FTS5 등) |
...
| [structure.md](./structure.md) | ✅ Approved | 2026-09-13 (v1.41) | NUBiz AX Initiative | 모노레포 폴더 구조 |
...
| 2026-09-14 | **모바일 "사진 추가하기" 신규(사용자 요청)** — mobile-schema.md v0.11→v0.12(§2.6 device_state.user_id 신규) | NUBiz AX Initiative |
